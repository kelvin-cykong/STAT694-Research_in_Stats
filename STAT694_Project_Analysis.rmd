...
SF_covid <- california_covid %>%
  ...
  mutate(case_per_100k = totalcountconfirmed/723724*100000)

LA_covid <- california_covid %>%
  filter(county=="Los Angeles") %>%
  mutate(date = as.Date(date)) %>%
  filter(date >= as.Date("2020-10-05"))%>%
  mutate(case_per_100k = totalcountconfirmed/3911500*100000)
...
kable(head(NYC_covid_raw),
      booktabs=TRUE,
      caption = "Raw NYC COVID-19 Data from GitHub") %>%
...
NYC_covid <- NYC_covid_raw %>%
  ...
  mutate(case_per_100k = total/8124427*100000)
